...
from mmdete.core import (anchor_inside_flags, build_anchor_generator, build_prior_generator,
...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def _get_bboxes(self,
        ...
        for cls_score, bbox_pred, anchors in zip(mlvl_cls_scores,
            ...
            from mmdete.core.export import get_k_for_topk
        ...
        if self.use_sigmoid_cls:
            ...
            # remind that we set FG labels to [0, num_class-1] since mmdete v2.0
            # BG cat_id: num_class
