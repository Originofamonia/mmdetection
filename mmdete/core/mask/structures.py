...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from mmdete.core.mask.structures import *  # NOQA
    ...
    def translate(self,
        ...
        Example:
            >>> from mmdete.core.mask.structures import BitmapMasks
    ...
    def random(cls,
        ...
        """
        from mmdete.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from mmdete.core.mask.structures import PolygonMasks
