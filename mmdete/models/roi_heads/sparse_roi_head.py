...
from mmdete.core import bbox2result, bbox2roi, bbox_xyxy_to_cxcywh
from mmdete.core.bbox.samplers import PseudoSampler
    ...
    def forward_train(self,
        ...
        Args:
            ...
            img_metas (list[dict]): list of image info dict where
                ...
                `mmdete/datasets/pipelines/formatting.py:Collect`.
